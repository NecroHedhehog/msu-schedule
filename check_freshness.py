...
Использование:
    ...
    python check_freshness.py --hours 12   (порог в часах, по умолчанию 8)

Cron-пример:
    0 */6 * * * cd /путь/к/проекту && python check_freshness.py
"""
...
def check(max_hours: float = DEFAULT_MAX_HOURS):
    ...
    # Находим все факультеты, которые когда-либо парсились
